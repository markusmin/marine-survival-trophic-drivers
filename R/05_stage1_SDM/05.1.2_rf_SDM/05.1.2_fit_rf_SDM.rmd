...
common_years_prey_field_model <- intersect(unique(csyif$year), # jsoes trawl
...
```{r}
# save.image(here::here("R", "05_stage1_SDM", "05.1.2_rf_SDM", "05.1.2_rf_SDM.rda"))
# load(here::here("R", "05_stage1_SDM", "05.1.2_rf_SDM", "05.1.2_rf_SDM.rda"))

compile(here::here("R", "05_stage1_SDM", "05.1.2_rf_SDM", "05_1_2_rf_SDM.cpp"))
...
rf_SDM_Params <- list(
  ...
  "epsilon_st_csyif"=matrix(0, nrow=nrow(trawl_spde$c0), ncol=rf_SDM_Data$n_t_jsoes),
  ...
  "epsilon_st_cssif"=matrix(0, nrow=nrow(trawl_spde$c0), ncol=rf_SDM_Data$n_t_jsoes),
  ...
  "epsilon_st_rf"=matrix(0, nrow=nrow(PRS_PWCC_spde$c0), ncol=rf_SDM_Data$n_t_rf)
  
)

rf_SDM_Obj = MakeADFun( data=rf_SDM_Data,
                                                parameters=rf_SDM_Params,
...
# Optimize
rf_SDM_Opt = nlminb( start=rf_SDM_Obj$par, obj=rf_SDM_Obj$fn, grad=rf_SDM_Obj$gr )
# add getJointPrecision for index
rf_SDM_Opt$SD = sdreport( rf_SDM_Obj, bias.correct=TRUE, getJointPrecision = TRUE )
rf_SDM_report = rf_SDM_Obj$report()

rf_SDM_output <- list(rf_SDM_Obj = rf_SDM_Obj,
                                              rf_SDM_Opt = rf_SDM_Opt,
                                              rf_SDM_report = rf_SDM_report)

save(rf_SDM_output,
     file = here::here("R", "05_stage1_SDM", "05.1.2_rf_SDM", "rf_SDM_output.rda"))
